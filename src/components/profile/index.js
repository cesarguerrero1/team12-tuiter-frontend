...
/**
 * Profile is the current user who is logged in. I am adding the functionality of our redux state to takeover the previously hardcoded items.
 * Additionally if no one is logged in then this page will redirect!
 * @returns JSX element for the user's profile
 */
const Profile = () => {

  const { currentUser } = useSelector((state) => { return state.users });
      ...
      {currentUser && 
          <div>
              <div className="border border-bottom-0">
                <h4 className="p-2 mb-0 pb-0 fw-bolder">{currentUser.username}<i className="fa fa-badge-check text-primary"></i></h4>
                <span className="ps-2">67.6K Tuits</span>
                <div className="mb-5 position-relative">
                  <img alt="Profile Header"className="w-100" src="../images/nasa-profile-header.jpg"/>
                  <div className="bottom-0 left-0 position-absolute">
                    <div className="position-relative">
                      <img alt="profile Logo" className="position-relative ttr-z-index-1 ttr-top-40px ttr-width-150px" src="../images/nasa-3.png"/>
                    </div>
                  </div>
                ...
                <div className="p-2">
                  <h4 className="fw-bolder pb-0 mb-0">{currentUser.username}<i className="fa fa-badge-check text-primary"></i></h4>
                  <h6 className="pt-0">@{currentUser.username}</h6>
                  ...
                  <p>
                    ...
                    {currentUser.joinedDate.slice(0,10)}
                  </p>
                  <b>178</b> Following
