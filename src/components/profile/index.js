        ...
        <div className="mb-5 position-relative">
          ...
          <div className="bottom-0 left-0 position-absolute">
            <div className="position-relative">
              <img alt="User Logo" className="position-relative ttr-z-index-1 ttr-top-40px ttr-width-150px" src="../images/nasa-3.png"/>
            </div>
          </div>
        ...
        <div className="p-2">
          ...
          <ul className="mt-4 nav nav-pills nav-fill">
              ...
              <li className="nav-item">
                  ...
                  <li className="nav-item"><Link to="/profile/media" className="nav-link">Media</Link>
              </li>
              <li className="nav-item">
