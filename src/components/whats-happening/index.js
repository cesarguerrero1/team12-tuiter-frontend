  ...
  return (
    <div className="ttr-whats-happening p-2">
      <div className="ttr-search position-relative">
        ...
        <input className="bg-secondary bg-opacity-10 border-0 form-control form-control-lg rounded-pill ps-5" placeholder="Search Tuiter" />
      </div>
            ...
            return (
              <div key={wh._id} className="ttr-whats-happening-tuit d-flex mb-3">
                <div className="flex-grow-1">
                  <h3 className="fs-6 fw-lighter">{wh.topic} - {wh['hours-ago']} hours ago</h3>
                ...
                <div>
                  <img alt="User Logo" src={`../images/${wh['user-logo']}`} className="ttr-rounded-15px ttr-user-logo" />
                </div>
              </div>
            );
          })
